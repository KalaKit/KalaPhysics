...
RELEASE_DLL="${ROOT_DIR}/build-release/bin/libKalaPhysics.so"
RELEASE_LIB="${ROOT_DIR}/build-release/lib/libKalaPhysics.a"
DEBUG_DLL="${ROOT_DIR}/build-debug/bin/libKalaPhysicsD.so"
DEBUG_LIB="${ROOT_DIR}/build-debug/lib/libKalaPhysicsD.a"
